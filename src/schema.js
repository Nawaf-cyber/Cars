'use strict';
/* =============================================================================
   مخطط قاعدة البيانات مدمج في الكود لا في ملف منفصل.
   السبب: الاستضافات بلا خادم تحزم الملفات المستوردة فقط، وقراءة ملف من القرص
   وقت التحميل تُسقط الدالة كلها إن لم يُحزم — بلا رسالة مفيدة.
