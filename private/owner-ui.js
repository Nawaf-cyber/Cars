...
(function injectPanel() {
  document.querySelector('#tabs')
    .insertAdjacentHTML('beforeend', '<button data-tab="owner">الاشتراك</button>');

  document.querySelector('main').insertAdjacentHTML('beforeend', `
    <section id="tab-owner" class="tab-panel hidden">
      ...
      <div class="panel">
        ...
        <p class="muted">ما لا تُفعّله هنا يبقى مقفلاً عند العميل مهما فعل مشرف النظام —
